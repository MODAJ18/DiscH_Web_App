...
def questions(request):
    # return HttpResponse(question_answered_points)
                    ...
                    if category is not None:
                        try:
                            ...
                            ans = Answer(answer_id=latest_answer_id, answer_category_num=category,
                                         answer_justification=just_cate, answer_upvote=0,
                                         account_id_id=request.user.id, question_id_id=question_id,
                                         date=datetime.date.today())
                        except:
                            ans = Answer(answer_id=1, answer_category_num=category,
